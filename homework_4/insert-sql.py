...
engine = sqlalchemy.create_engine('postgresql://postgres:575863@localhost:5432/postgres')
...
albums = [('Courage', 2019), ('One more light', 2018), ('Fish', 2020), ('Made in Heaven', 1995), ('Weight', 2020),
          ('Smile', 2020), ('Velvet', 2020), ('Rosenrot', 2005)]
tracks = [(47, 'My Heart', 150), (50, 'In the end', 115), (53, 'Electro', 120), (50, 'Rhapsody', 150),
          (51, 'Perseverance', 100), (53, 'Call me', 100), (53, 'If i have', 200), (54, 'Du hast', 210)]
...
connection.execute("""
    INSERT INTO
        album(name, year)
    VALUES('Trespassing', 2012);
    INSERT INTO
        musicianalbum(musician_id, album_id)
    VALUES(7, 55);
    INSERT INTO
        track(album_id, name, duration)
    VALUES(55, 'Underneath', 255);
    INSERT INTO
        trackcollection(track_id, collection_id)
    VALUES(9, 2);
""")
